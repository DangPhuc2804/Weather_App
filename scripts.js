...
const hourlyWeatherDiv = document.querySelector(".weather-section .weather-list");
...
const weatherCodes = {
  ...
  mist: [1030, 1135, 1147],
  rain: [
    1063, 1150, 1153, 1168, 1171, 1180, 1183, 1198, 1201,
    ...
    .map((item) => {
      ...
      return `
        <li class="weather-item">
          <p class="time">${time}</p>
          <img src="icons/${weatherIcon}.svg" alt="weather-icon" />
...
const getWeatherDetails = async (API_URL) => {
  ...
  try {
    ...
    currentWeatherDiv.querySelector("img").src = `icons/${weatherIcon}.svg`;
    ...
    // Kết hợp dữ liệu dự báo giờ của 2 ngày
...
// Gửi request API theo tên thành phố
...
setupWeatherRequest("ho chi minh city");
